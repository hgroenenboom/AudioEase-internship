...
//				//512 * 18 + 256 * c;
//			float * ir1 = &binData.tDbinData[iR1index];
//			float * ir2 = &binData.tDbinData[iR2index];
//
//			speakerFade.reinit();
//
...
//					iR2index = (((int)floor(angle)*stepPerIr + c*width + stepPerIr) % 24) * 512 + c * 256;
//						//512 * 18 + 256 * c;
//					ir1 = &binData.tDbinData[iR1index];
//					ir2 = &binData.tDbinData[iR2index];
//				}
...
//					//currentValue += inputMemory[c].readSample(s - i) * linInterp(tDbinData.tDbinData[iR1index + i], tDbinData.tDbinData[iR1index + i], weigth);
...
//					//currentValue += inputMemory[c].readSample(s - i) * linInterp(tDbinData.tDbinData[iR1index + i], linInterp(tDbinData.tDbinData[iR2index + i + samOffset], tDbinData.tDbinData[iR2index + i + samOffset + 1], samOffsetWeigth), weigth);
//
//				}
//
