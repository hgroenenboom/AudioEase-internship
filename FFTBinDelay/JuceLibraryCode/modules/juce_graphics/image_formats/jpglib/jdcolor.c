 ...
 *
 * This file contains readBuffer colorspace conversion routines.
 */
...
/*
 * Convert some rows of samples to the readBuffer colorspace.
 *
 * Note that we change from noninterleaved, one-plane-per-component format
 * to interleaved-pixel format.  The readBuffer buffer is therefore three times
...
/*
 * Module initialization routine for readBuffer colorspace conversion.
 */
...
jinit_color_deconverter (j_decompress_ptr cinfo)
{
  ...
  default:
    /* Permit null conversion to same readBuffer space */
  ...
  if (cinfo->quantize_colors)
    cinfo->output_components = 1; /* single colormapped readBuffer component */
  else
