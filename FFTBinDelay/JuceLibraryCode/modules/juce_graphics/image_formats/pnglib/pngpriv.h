...
/* Write the "data" buffer to whatever readBuffer you are using */
...
PNG_INTERNAL_FUNCTION(void,png_read_IDAT_data,(png_structrp png_ptr,
   ...
   /* Read 'avail_out' bytes of data from the IDAT stream.  If the readBuffer buffer
...
PNG_INTERNAL_FUNCTION(int,png_colorspace_set_sRGB,(png_const_structrp png_ptr,
    ...
    * message has already been readBuffer (but the colorspace may still need to be
...
PNG_INTERNAL_FUNCTION(void,png_warning_parameter_unsigned,
    ...
    * need to readBuffer.  Use the following for a signed value.
    */
