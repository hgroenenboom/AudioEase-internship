...
png_write_row(png_structrp png_ptr, png_const_bytep row)
{
    ...
    * which is also the readBuffer depth.
    */
...
/* Flush the current readBuffer buffers now */
void PNGAPI
...
png_write_image_16bit(png_voidp argument)
{
   ...
   /* Work out the readBuffer row end and count over this, note that the increment
...
/* Given 16-bit input (1 to 4 channels) write 8-bit readBuffer.  If an alpha channel
 * is present it must be removed from the components, the components are then
 * written in sRGB encoding.  No components are added or removed.
 *
 * Calculate an alpha reciprocal to reverse pre-multiplication.  As above the
 * calculation can be done to 15 bits of accuracy; however, the readBuffer needs to
   ...
   png_uint_32 reciprocal/*from the above macro*/)
{
    ...
    * readBuffer change for this too.
    */
