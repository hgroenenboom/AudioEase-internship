...
public:
    ...
    */
    ...
    /** Renders the next block of data for this voice.
        ...
        The readBuffer audio data must be added to the current contents of the buffer provided.
    ...
    */
    ...
    /** Changes the voice's reference sample rate.
        ...
        The rate is set so that subclasses know the readBuffer rate and can set their pitch
        accordingly.
...
/**
    ...
    they can pitch their readBuffer correctly.
*/
...
public:
    ...
    */
    ...
    /** Creates the next block of audio readBuffer.

        This will process the next numSamples of data from all the voices, and add that readBuffer
        ...
        both to the audio readBuffer buffer and the midi input buffer, so any midi events
