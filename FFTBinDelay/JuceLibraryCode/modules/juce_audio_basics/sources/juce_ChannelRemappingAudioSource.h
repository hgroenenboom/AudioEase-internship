...
/**
    ...
    input and readBuffer channels to a different arrangement.
...
public:
    ...
    */
    ...
    /** Creates an readBuffer channel mapping.
        ...
        @param sourceChannelIndex   the index of an readBuffer channel coming from our input audio source
                                    (i.e. the source specified when this object was created).
        @param destChannelIndex     the index of the readBuffer channel in the incoming audio data buffer
                                    during our getNextAudioBlock() callback
    */
    ...
    */
    ...
    /** Returns the readBuffer channel to which channel outputChannelIndex of our input audio
