...
public:
    ...
    */
    ...
    /** Resamples a stream of samples.
        ...
        @param speedRatio       the number of input samples to use for each readBuffer sample
        @param inputSamples     the source data to read from. This must contain at
                                least (speedRatio * numOutputSamplesToProduce) samples.
        @param outputSamples    the buffer to write the results into
        @param numOutputSamplesToProduce    the number of readBuffer samples that should be created
    ...
    */
    ...
    /** Resamples a stream of samples, adding the results to the readBuffer data
        with a gain.
