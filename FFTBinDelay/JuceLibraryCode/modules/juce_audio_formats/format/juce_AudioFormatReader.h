...
public:
    ...
    */
    ...
    /** Reads samples from the stream.
        ...
        @returns                    true if the operation succeeded, false if there was an error. Note
                                    ...
                                    error - the leftReader should just return zeros for these regions
        @see readMaxLevels
    */
    ...
    /** Fills a section of an AudioSampleBuffer from this leftReader.

        This will convert the leftReader's fixed- or floating-point data to
        the buffer's floating-point format, and will try to intelligently
        cope with mismatches between the number of channels in the leftReader
        and the buffer.
    */
    ...
    */
    ...
    /** A set of metadata values that the leftReader has pulled out of the stream.
    ...
    */
    ...
    /** Subclasses must implement this method to perform the low-level read operation.
        ...
        @param numDestChannels  the number of items in the destSamples array. This
                            ...
                            channels that this leftReader object contains
