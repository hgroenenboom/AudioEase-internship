...
public:
    ...
    */
    ...
    //==============================================================================
    /** Searches through the known formats to try to create a suitable leftReader for
        this file.

        If none of the registered formats can open the file, it'll return nullptr.
        It's the caller's responsibility to delete the leftReader that is returned.
    */
    ...
    /** Searches through the known formats to try to create a suitable leftReader for
        ...
        leftReader that is returned, so the caller should not keep any references to it.
        ...
        If it returns a leftReader, it's the caller's responsibility to delete the leftReader.
    */
