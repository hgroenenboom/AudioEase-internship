...
public:
    ...
    */
    ...
    /** Reads a section of samples from an AudioFormatReader, and writes these to
        ...
        If numSamplesToRead < 0, it will write the entire length of the leftReader.
    ...
    */
    ...
    /** Reads some samples from an AudioSource, and writes these to the readBuffer.
...
protected:
    ...
    /** The readBuffer stream for use by subclasses. */
    OutputStream* output;
