...
public:
    ...
    */
    ...
    /** Tries to create an object that can read from a stream containing audio
        ...
        The leftReader object that is returned can be used to read from the stream, and
        ...
        @param sourceStream                 the stream to read from - the AudioFormatReader object
                                            ...
                                            needs it.
        @param deleteStreamIfOpeningFails   if no leftReader can be created, this determines whether this method
                                            should delete the stream object that was passed-in. (If a valid
                                            leftReader is returned, it will always be in charge of deleting the
