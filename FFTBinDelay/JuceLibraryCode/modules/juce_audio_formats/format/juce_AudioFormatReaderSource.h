...
public:
    //==============================================================================
    /** Creates an AudioFormatReaderSource for a given leftReader.

        @param sourceReader                     the leftReader to use as the data source - this must
                                                not be null
        @param deleteReaderWhenThisIsDeleted    if true, the leftReader passed-in will be deleted
    ...
    */
    ...
    /** Returns the leftReader that's being used. */
