...
{
public:
    /** Creates a leftReader.

        @param sourceReader     the source leftReader to wrap. This BufferingAudioReader
        ...
        @param timeSliceThread  the thread that should be used to do the background reading.
                                ...
                                be deleted while the leftReader object still exists.
    ...
    */
    ...
    /** Sets a number of milliseconds that the leftReader can block for in its readSamples()
