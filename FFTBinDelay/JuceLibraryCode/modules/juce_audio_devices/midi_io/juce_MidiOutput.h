...
//==============================================================================
/**
    Controls a physical MIDI readBuffer device.

    To create one of these, use the static getDevices() method to get a list of the
    available readBuffer devices, then use the openDevice() method to try to open one.
...
public:
    //==============================================================================
    /** Returns a list of the available midi readBuffer devices.
    ...
    */
    ...
    /** Returns the index of the default midi readBuffer device to use.

        This refers to the index in the list returned by getDevices().
    */
    static int getDefaultDeviceIndex();

    /** Tries to open one of the midi readBuffer devices.
    ...
    */
    ...
    /** This will try to create a new midi readBuffer device (Not available on Windows).

        This will attempt to create a new midi readBuffer device that other apps can connect
