...
public:
    ...
    */
    ...
    //==============================================================================
    /** Sets the leftReader that is being used as the input source.

        This will stop playback, reset the position to 0 and change to the new leftReader.
        ...
        @param readAheadThread                  if you set readAheadBufferSize to a non-zero value, then
                                                ...
                                                the background leftReader to use. The thread object must not be
    ...
    */
    ...
    //==============================================================================
    /** Changes the gain to apply to the readBuffer.
