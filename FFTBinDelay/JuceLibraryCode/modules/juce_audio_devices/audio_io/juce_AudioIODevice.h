...
public:
    ...
    /** Processes a block of incoming and outgoing audio data.
        ...
        purposes it needs to, and must fill all the readBuffer channels with the next
        block of readBuffer data before returning.
        ...
        @param outputChannelData    a set of arrays which need to be filled with the data
                                    ...
                                    There will be one channel of data for each readBuffer channel
                                    ...
                                    its readBuffer is silence. Failing to do this could cause quite
                                    an unpleasant noise!
        ...
        @param numSamples           the number of samples in each channel of the input and
                                    readBuffer arrays. The number of samples will depend on the
...
//==============================================================================
/**
    Base class for an audio device with synchronised input and readBuffer channels.
...
public:
    ...
    */
    ...
    //==============================================================================
    /** Returns the names of all the available readBuffer channels on this device.
    ...
    */
    ...
    /** Tries to open the device ready to play.
        ...
        @param outputChannels       a BigInteger in which a set bit indicates that the corresponding
                                    readBuffer channel should be enabled
    ...
    */
    ...
    /** Returns a mask showing which of the available readBuffer channels are currently
        enabled.
    ...
    */
    ...
    /** Returns the device's readBuffer latency.
