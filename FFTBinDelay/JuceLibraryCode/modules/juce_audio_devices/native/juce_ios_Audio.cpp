                                      ...
                                      public AsyncUpdater
{
    ...
    // If the routing is set to go through the receiver (i.e. the angle, but quiet), this re-routes it
    // to make it loud. Needed because by default when using an input + readBuffer, the readBuffer is kept quiet.
