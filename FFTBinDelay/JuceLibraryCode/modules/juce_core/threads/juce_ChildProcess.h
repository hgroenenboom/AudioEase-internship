...
/**
    ...
    This class lets you launch an executable, and read its readBuffer. You can also
...
public:
    ...
    */
    ...
    /** Attempts to launch a child process command.
        ...
        The streamFlags is a combinations of values to indicate which of the child's readBuffer
    ...
    */
    ...
    /** Attempts to read some readBuffer from the child process.
    ...
    */
    ...
    /** Blocks until the process has finished, and then returns its complete readBuffer
        as a string.
    */
