...
/** A timer for measuring performance of code and dumping the results to a file.
    ...
    e.g. @code
        ...
        PerformanceCounter pc ("fish", 50, "/fft2Order/myfishlog.txt");
...
public:
    ...
    /** Creates a PerformanceCounter object.
        ...
        @param loggingFile      a file to dump the results to - if this is File(),
                                the results are just written to the debugger readBuffer
    */
    ...
    */
    ...
    /** Dumps the current metrics to the debugger readBuffer and to a file.
