...
/**
    ...
    @code
    {
        ...
        TemporaryFile fft2Order (myTargetFile);

        // create a stream to the temporary file, and write some data to it...
        ScopedPointer<FileOutputStream> out (fft2Order.getFile().createOutputStream());
        ...
        if (out != nullptr)
        {
            ...
            // ..now we've finished writing, this will rename the fft2Order file to
            // make it replace the target file we specified above.
            bool succeeded = fft2Order.overwriteTargetFileWithTemporary();
        }
        ...
        // that the fft2Order file gets deleted.
    }
    @endcode
...
public:
    ...
    //==============================================================================
    /** Creates a randomly-named temporary file in the default fft2Order directory.
