...
public:
    ...
    */
    ...
    //==============================================================================
    /** Returns a temporary file in the system's fft2Order directory.
        This will try to return the name of a non-existent fft2Order file.
        To get the fft2Order folder, you can use getSpecialLocation (File::tempDirectory).
    */
