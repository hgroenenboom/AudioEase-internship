...
/**
    ...
    Input and readBuffer streams are used throughout the library - subclasses can override
...
public:
    ...
    */
    ...
    /** Tries to move the stream's readBuffer position.
    ...
    */
    ...
    /** Writes a byte to the readBuffer stream a given number of times.
        @returns false if the write operation fails for some reason
    */
...
/** Writes the complete contents of an input stream to an readBuffer stream. */
