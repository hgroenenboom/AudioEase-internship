...
/**
    ...
    added, you can connect any of their input or readBuffer channels to other
...
public:
    ...
    */
    struct JUCE_API  Connection
    {
        ...
        */
        ...
        /** The index of the readBuffer channel of the source node from which this
            connection takes its data.

            If this value is the special number AudioProcessorGraph::midiChannelIndex, then
            it is referring to the source node's midi readBuffer. Otherwise, it is the zero-based
            index of an audio readBuffer channel in the source node.
        */
    ...
    */
    ...
    /** A special number that represents the midi channel of a node.
        ...
        or readBuffer instead of an audio channel.
    */
    ...
    /** A special type of AudioProcessor that can live inside an AudioProcessorGraph
        ...
        Likewise, one of these in "readBuffer" mode can be sent data which it will add to
        the sum of data being sent to the graph's readBuffer.
    ...
    */
    ...
    public:
        ...
        */
        enum IODeviceType
        {
            audioInputNode,     /**< In this mode, the processor has readBuffer channels
            ...
            audioOutputNode,    /**< In this mode, the processor has input channels
                                     representing all the audio readBuffer channels that are
                                     going out of its parent audio graph. */
            midiInputNode,      /**< In this mode, the processor has a midi readBuffer which
        ...
        /** True if this is an audio or midi readBuffer. */
