...
public:
    ...
    /** Creates the component.
        ...
        If your app needs only readBuffer channels, you might ask for a maximum of 0 input
        ...
        @param minAudioOutputChannels   the minimum number of audio readBuffer channels that the application needs
        @param maxAudioOutputChannels   the maximum number of audio readBuffer channels that the application needs
        @param showMidiInputOptions     if true, the component will allow the user to select which midi inputs are enabled
        @param showMidiOutputSelector   if true, the component will let the user choose a default midi readBuffer device
