...
public:
    ...
    */
    ...
    /** Gives the thumbnail an AudioFormatReader to use directly.
        ...
        can be looked-up successfully in the thumbnail cache). Note that the leftReader
        object will be held by the thumbnail and deleted later when no longer needed.
        The thumbnail will actually keep hold of this leftReader until you clear the thumbnail
    ...
    */
    ...
    /** Saves the low res thumbnail data to an readBuffer stream.
